...
class EducationController extends Controller
{
    ...
    {
        return view('BackOffice.create_education',['educations'=>Education::all(),'nav'=>'educationActive']);
    }
    ...
    {
        return view('BackOffice.show_education',['education'=>Education::findOrFail($id),'nav'=>'educationActive']);
    }
