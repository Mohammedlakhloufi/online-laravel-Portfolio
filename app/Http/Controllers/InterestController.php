...
class InterestController extends Controller
{
    ...
    {
        return view('BackOffice.create_interest',['interests'=>Interest::all(),'nav'=>'interestActive']);
    }

    public function store_interest(Request $req )
    {
        $req->validate(['content'=>'required|max:1000']);
    ...
    {
        return view('BackOffice.show_interest',['interest'=>Interest::findOrFail($id),'nav'=>'interestActive']);
        return back();
    }
